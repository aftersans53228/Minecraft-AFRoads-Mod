...
public class AFRoadsItemRegistry {
    ...
    private static ItemGroup registerGroup(String id, ItemGroup group) {
        return Registry.register(Registries.ITEM_GROUP, new Identifier(AFRoadsStatics.MOD_ID,id),group);
    }
    ...
    //group
    public static ItemGroup NormalRoadBlockGROUP;
    public static ItemGroup RoadDecorationGROUP;
    public static ItemGroup RoadStickerGROUP;
    ...
    public static void RegisterItem(){
        ...
        NormalRoadBlockGROUP =registerGroup("normal_road_block",NormalRoadBlock.get());
        RoadStickerGROUP =registerGroup("road_sticker",RoadStickers.get());
        RoadDecorationGROUP =registerGroup("road_decoration",RoadDecoration.get());
