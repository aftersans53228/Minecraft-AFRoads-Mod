...
public class InsulationPanelsRailings extends HorizontalFacingBlock {
    public static final BooleanProperty is_Turn = BooleanProperty.of("is_turn");
    public InsulationPanelsRailings() {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView view, BlockPos pos, ShapeContext ctx) {
        ...
        switch(dir) {
            case NORTH:
            case SOUTH:
                return VoxelShapes.cuboid(0.125f, 0.0f, 0.0f, 0.875f, 2f, 1.0f);
            case EAST:
            case WEST:
                return VoxelShapes.cuboid(0.0f, 0.0f, 0.125f, 1.0f, 2f, 0.875f);
            default:
